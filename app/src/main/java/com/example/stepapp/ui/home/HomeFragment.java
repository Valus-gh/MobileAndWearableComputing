            ...
            public void onButtonChecked(MaterialButtonToggleGroup group, int checkedId, boolean isChecked) {
                if (group.getCheckedButtonId() == R.id.toggleStart) {
                    ...
                    if(sensorStepDetector != null)
                        sensorManager.registerListener(listener, sensorStepDetector, SensorManager.SENSOR_DELAY_NORMAL);
                    else
                    ...
                    sensorManager.unregisterListener(listener, sensorACC);
                    sensorManager.unregisterListener(listener, sensorStepDetector);
